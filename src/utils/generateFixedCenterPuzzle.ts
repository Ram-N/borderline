/**
 * Deterministic puzzle generation with a forced center country.
 * Variant of generateDailyPuzzle.ts that accepts a specific country code
 * instead of picking randomly. Used by the canned puzzle generator.
 */
...
export function generateFixedCenterPuzzle(
  center: string,
  ...
  if (allNeighbors.length < minNeighbors) return null;
